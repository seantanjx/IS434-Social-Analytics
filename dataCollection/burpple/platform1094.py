...
def main():
    ...
    driver.get('https://www.burpple.com/platform-1094')

    #Retrieving of restaurant details

    #location
    location_xpath = driver.find_elements_by_xpath('/html/body/div[3]/div[3]/div/div/div/div[3]/div[1]/a')

    #name
    name_xpath = driver.find_elements_by_xpath('/html/body/div[3]/div[3]/div/div/div/h1/a')

    #category
    categories_xpath = driver.find_elements_by_xpath('/html/body/div[3]/div[3]/div/div/div/div[4]/a')
    ...
    num_of_review_xpath = driver.find_element_by_xpath('/html/body/div[3]/div[3]/div/div/div/div[2]/div[1]/a')
    ...
    print('Loading done for Platform')
