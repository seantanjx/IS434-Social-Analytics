    ...
    try:
        ...
        while profile_name != "":
            try:
                ...
                post_to_take = max(20, ceil(profile.mediacount * X_percentage / 100))
                for post in islice(posts_sorted_by_likes, post_to_take):
                    print(post)
                    likes = likes | set(post.get_likes())
                    # c += 1
                    # if c >= 20: #likes from max 20 post
                    #     break
